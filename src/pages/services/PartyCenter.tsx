...
const firstBullet2 =
  "Tailored party packages to suit specific celebration needs.";
...
const secBullet3 =
  "All-inclusive packages catering to various budgets and preferences.";
  ...
  return (
    <>
      ...
      <ServiceGrid
        ...
        firstBullet2={firstBullet2}
        firstBullet3={firstBullet3}
        heading3={heading3}
        secBullet1={secBullet1}
        secBullet2={secBullet2}
        secBullet3={secBullet3}
