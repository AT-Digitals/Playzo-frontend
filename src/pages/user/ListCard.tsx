                ...
                <Stack direction="column" spacing={2} key={index} py={2}>
                    ...
                    >
                        ...
                        <Rating
                            ...
                            readOnly
                            sx={{
                                ".css-1c99szj-MuiRating-icon": { color: `${Colors.BUTTON_COLOR}` },
                            }}
                        />
                    </Stack>
                    <Typography variant="body2" fontWeight={600}>
                    ...
                    >
                        {user.comments === "" ?
                            ...
                            <Stack direction="row" spacing={1} alignItems="baseline">
                                <img src={Vector} width={15} height={15} />
                                <Typography variant="body2" width={360}>{user.comments}</Typography>
                            </Stack>
                        ...
                        {user.bookingCompleted === "yes" ?
                            ...
                            </Stack> : (user.bookingCompleted === "no" && user.refundCompleted === "yes") ?
